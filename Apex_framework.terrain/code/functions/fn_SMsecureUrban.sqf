...
[
	...
	TRUE,
	[
		'Ворог постачає повстанцям передові системи наведення для протиповітряних пускових установок. Прямуйте туди і захопіть ящики. У відмічених областях буде розташовано 3 ящики. Обшукуйте будівлі поблизую',
