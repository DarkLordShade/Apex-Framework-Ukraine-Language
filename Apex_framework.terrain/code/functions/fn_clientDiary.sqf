...
player createDiaryRecord [
	...
	[
		...
		<br />3. Стрільба/Крики в радыоканалах не допустимі.
		...
		<br />5. Розмова у каналі Side лагуча тож ніхто вас на зможе нормально розуміти. Краще пишіть в цьому каналі. Для розмови використовуйте канал Group, а ще краще - приєднутесь до нас у Discord
