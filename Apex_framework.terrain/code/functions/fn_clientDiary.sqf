...
player createDiaryRecord [
	...
	[
		...
		'Поблизу з Зоною ящикiв та Зоною спорядження на базi у вас з’явиться можливiсть редагувати спорядження в транспортi та в ящиках з амунiцiєю.'
	]
];
...
player createDiaryRecord [
	...
	[
		...
		'Щоб пiдняти солдата просто завантажте його в медичний транспорт (HEMTT медичний, Медичний модуль Taru i  т.i.)<br/><br/>Транспорт повинен мати потрiбну кiлькiсть квиткiв на вiдродженняВiдродження гравцiв використовує квитки.<br/>Квитки на вiдродження пожуть бути вiдновленi на Сервiсних маркерах на базi.<br/>Кiлькiсть квиткiв на вiдродження вiдповiдає кiлькостi мiсць в транспортi.'
	]
];
...
player createDiaryRecord [
	...
	[
		'Загальне',
		(format ['Forward Operating Bases (Передовi Оперативнi Бази - ПОБ) розкиданi навкруги %1.<br/><br/>Даякi послуги доступнi на цих ПОБах, а також вони є об’єктами пiдвищеного iнтересу супротивника.',worldName])
	]
];
...
player createDiaryRecord [
	...
	[
		'Послуги радару',
		'Коли ПОБ активний та утримується вашими силами - ворожi карти та радари будуть для вас доступними.<br/><br/>Для взаємодiї з ПОБами всерединi головного будинку розмiщено ноутбуки.<br/>Коли певнi типи транспорту/ящикiв пiдпадають пiд радiус дiї ПОБа вони можуть активувати певнi сервiси.<br/>'
	]
];
...
player createDiaryRecord [
	...
	[
		...
		- Вiдродження - Приведiть HEMTT Mover або HEMTT Box на ПОБ для активацiї послуги респавну транспорту<br/>
...
player createDiaryRecord [
	...
	[
		'Оживлювач',
		'Отримуйте бали як Медик за оживлення поранених товаришiв.<br/><br/>МультиплеєриТоп 3 медика тижня (закiнчується в Недiлю о 23:59) додаються до бiлого списку слотiв медика на наступний тиждень.'
	]
];
player createDiaryRecord [
	'QS_diary_leaderboards',
	[
		'Транспортер',
		'Отримуйте бали за безпечне транспортування солдатiв з/на базу гелiкоптерами.<br/><br/>Мультиплеєри: Розширена модель пiлотування<br/><br/>Топ 3 пiлоти тижня (закiнчується в Недiлю о 23:59) додаються до бiлого списку слотiв пiлотiв на наступний тиждень.<br/><br/>Транспортування на пiдвiсi не пiдтримується наразi.<br/>Повантаження транспорту не пiдтримується наразi.'
	]
];
player createDiaryRecord [
	'QS_diary_leaderboards',
