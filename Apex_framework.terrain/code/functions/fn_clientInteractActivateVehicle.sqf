...
if (
	...
	50 cutText ['Броньовану техніку заборонено використовувати цього разу (налаштування сервера)','PLAIN DOWN',0.75];
};
private _exit = FALSE;
...
if (_exit) exitWith {
	50 cutText ['Занадто багато техніки активовано (3+ за 5 хвилин), спробуйте пізніше','PLAIN DOWN',0.5];
};
