	...
	[(["O_MBT_02_arty_F","O_T_MBT_02_arty_ghex_F"] select (worldName in ['Tanoa','Lingor3'])),[4.01807,-1.67236,-0.0691381],353.719,[],true,true,false,{
		...
		(gunner _arty) addEventHandler [
			'FiredMan',
			{
				...
				_firingMessages = [
					"Термічне сканування показало, що ворог здійснив постріли з артилерії! Пригнутися!",
					"Ворожі снаряди на підльоті! До укриттів негайно!",
					"Снаряди OPFOR наближаються! Шукайте укриття негайно!",
					"Працює артилерія, хлопці! На землю!",
					"Заткніть цю кляту артилерію; вони гатять прямо зараз! В укриття!",
					"Постріли! По нам б’є артилерія, пики в землю!"
				];
